...
let prospect1 = new Persona("Enzo", "Díaz", "enzodiaz@mail.com");
prospect.concatenar();
clientes.push(prospect);

let prospect2 = new Persona("Camila", "Ramirez", "ramirezC@mail.com");
prospect.concatenar();
clientes.push(prospect2);

let prospect3 = new Persona("Santiago", "Simón", "santisimon@mail.com");
prospect.concatenar();
clientes.push(prospect2);
